...
public class BoxLayoutTest extends JFrame {
    ...
    public void init(){
        //重新设置窗体布局  具水平和垂直间距的BorderLayout
        ...
        //topPanel设置背景色和合适的大小
        topPanel.setBackground(new Color(255,213,2));
        topPanel.setPreferredSize(new Dimension(414,100));

        //左侧按钮
        JButton leftButton = new JButton("扫  扫");
        ...
        for (int i = 0;i<3;i++){
            ...
            jPanel.setBackground(new Color(246,162,172));
